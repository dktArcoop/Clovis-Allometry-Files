...
par(mfcol = c(1,1))
#Figure 7
plot(NCgroups[,3:4],xaxt="none",yaxt="none", xlab="", ylab="")#sets plot box and 75 points
...
points(NCgroups[which(ClassO2=="S"),3:4],pch=21,cex=1,col="blue",bg="blue") #color and shape of small size class
points(NCgroups[which(ClassO2=="M"),3:4],pch=22,cex=1,col="green",bg="green") #color and shape of medium size class
points(NCgroups[which(ClassO2=="L"),3:4],pch=24,cex=1,col="red",bg="red") #color and shape of large size class
points(NCgroups[which(ClassO2=="BWM"),3:4],pch=5,cex=1,col="black") #shapes for small BWD points
points(NCgroups[which(ClassO2=="CBY"),3:4],pch=3,cex=1,col="black") #shape for large Colby point
```

Bivariate plot of Stem Width and Blade Length (figure 9)

```{r}
plot(NCgroups[,5:4],xaxt="none",yaxt="none", xlab="", ylab="")
axis(1,seq(15,90,5))
...
points(NCgroups[which(ClassO2=="S"),5:4],pch=21,cex=1,col="blue",bg="blue")
points(NCgroups[which(ClassO2=="M"),5:4],pch=22,cex=1,col="green",bg="green")
points(NCgroups[which(ClassO2=="L"),5:4],pch=24,cex=1,col="red",bg="red")
points(NCgroups[which(ClassO2=="BWM"),5:4],pch=5,cex=1,col="black")
points(NCgroups[which(ClassO2=="CBY"),5:4],pch=3,cex=1,col="black")
```

Bivariate plot of Stem Length and Blade Length (figure 10)

```{r}
plot(NCgroups[,c(5,3)],xaxt="none",yaxt="none", xlab="", ylab="")
axis(1,seq(15,90,5))
...
points(NCgroups[which(ClassO2=="S"),c(5,3)],pch=21,cex=1,col="blue",bg="blue")
points(NCgroups[which(ClassO2=="M"),c(5,3)],pch=22,cex=1,col="green",bg="green")
points(NCgroups[which(ClassO2=="L"),c(5,3)],pch=24,cex=1,col="red",bg="red")
points(NCgroups[which(ClassO2=="BWM"),c(5,3)],pch=5,cex=1,col="black")
points(NCgroups[which(ClassO2=="CBY"),c(5,3)],pch=3,cex=1,col="black")
```
